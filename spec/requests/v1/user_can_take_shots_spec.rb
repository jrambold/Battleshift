...
describe "Api::V1::Shots" do
  context "POST /api/v1/games/:id/shots" do
    ...
    it "updates the message and board with a miss for player_1" do
      game = create(:game, player_1_board: player_1_board, player_2_board: player_2_board, player_1_turns: 1)
    ...
    it "updates the message and board with a miss for both player_2" do
      game = create(:game, player_1_board: player_1_board, player_2_board: player_2_board, current_turn: "player_2", player_1_turns: 1)
      json_payload = {target: "A1"}.to_json
    ...
    it "cannot fire until ships are placed" do
      ...
      expect(response.status).to eq(400)
      expected_messages = "Ships not placed"
    end
  end
end
